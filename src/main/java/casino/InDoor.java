...
public class InDoor {
    ...
    public static Response processRegisterRequest(RegisterRequest request) {
        ...
        // If we still do not have Exception response created
        if (response == null) {
    ...
    /*
     * commands: user commands: - register Player set Player Name set Password
     * /*
     */

    /*
     * - all bets done, perform spin (test table) UUID password /*
     */

    /*
     * - take Bet from user UUID password table type bet type stake number /*
     */

    /*
     * administrator commands: - deleteAllPlayers administrator UUID password /*
     */
